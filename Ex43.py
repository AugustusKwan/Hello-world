...
class CentralCorridor(Scene):
    ...
    def enter(self):
        print "The Gothons of Planet Percal #25 have invaded your ship and destoyed"
...
#Class Laser WeaponArmory(Scene)
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        ...
        if guess == code:
            ...
            print "melthing sound as the mechanism is fused together."
...
class EscapePod(Scene):
    def enter(self):
        ...
        print "interference. You get to the ship,so your run is clear of"
        ...
        if int(guess) != good_pod:
            ...
            print "You jump into pod %s and hit the eject button." % guess
            print "The pod easilly slides out into space heading to"
